...
const Dashboard = () => {
    ...
    return (
        <>
            ...
            <section
                className='flex flex-col justify-center items-center min-h-screen w-screen max-w-[1200px] max-h-[800px] p-2 md:m-0 mb-8 bg-backgroundPrimary overflow-hidden'
            >
